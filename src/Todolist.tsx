...
export function Todolist(props: PropsType) {
    ...
    //3. Relocate everything associated with  filters
    ...
    //2. Let's create a fourth filter button-if you click it,
    // the first three tasks will be displayed
    if (filter === "first tree") {
